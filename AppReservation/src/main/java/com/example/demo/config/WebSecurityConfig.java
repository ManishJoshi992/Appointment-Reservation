...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		.antMatchers("GET/person/**").hasAnyRole("Admin")
		.antMatchers("POST/person/**").hasAnyRole("Admin")
		.antMatchers("DELETE/person/**").hasAnyRole("Admin")
		.antMatchers("PUT/person/**").hasAnyRole("Admin")
